...
import { Activity, Clock, Dumbbell, Heart, Share2 } from "lucide-react";
import { 
  Card, 
  CardContent, 
  CardDescription, 
      ...
      <Card className="overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-chart-1/20 to-chart-2/20 dark:from-chart-1/10 dark:to-chart-2/10">
          <div className="flex justify-between items-start">
            <div>
              <CardTitle className="text-2xl">{data.workout_name}</CardTitle>
          ...
          <div className="flex flex-wrap gap-6 mb-6">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-medium">{data.calories_burned} kcal</p>
              </div>
            </div>
            <div className="flex items-center">
